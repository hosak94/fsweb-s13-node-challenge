...
router.get("/:id", mw.validateProjectsId, (req, res, next) => {
  try {
...
router.delete("/:id", mw.validateProjectsId, async (req, res, next) => {
  try {
...
router.get("/:id/actions", mw.validateProjectsId, async (req, res, next) => {
  try {
